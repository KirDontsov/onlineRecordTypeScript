...
interface QuizProps extends Partial<ReturnType<typeof mapState>>, Partial<ReturnType<typeof mapDispatch>> {
	navigation?: any;
	searchTerm?: string;
	city?: string;
	data?: any;
	...
	render() {
		...
		return (
			<SafeAreaView style={styles.container}>
				...
				<AppButton title="Выбрать специалиста" onPress={() => this.nextSpecialist()} />
