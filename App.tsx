...
import { HomeScreen, MapScreen, ProfileScreen, RecordScreen, SpecialistScreen } from "./z_screens";
...
const config = {
	...
	headerBackground: () => <BlurView tint="light" intensity={10} style={StyleSheet.absoluteFill} />
};
...
function HomeStackScreen() {
	return (
		<HomeStack.Navigator initialRouteName="Home" screenOptions={config} headerMode="float">
			<HomeStack.Screen
				name="City"
...
function ProfileStackScreen() {
	return (
		<ProfileStack.Navigator headerMode="float" screenOptions={{ ...config, headerTintColor: "#fff" }}>
			<ProfileStack.Screen
				name="Profile"
